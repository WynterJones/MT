...
interface EditBankCardFormProps {
  card: BankCard;
  onClose: () => void;
}

const EditBankCardForm = ({ card, onClose }: EditBankCardFormProps) => {
  const { updateBankCard } = useAppData();
  const [formData, setFormData] = useState({
    bank: card.bank,
    accountName: card.accountName,
    accountType: card.accountType,
    accountNumber: card.accountNumber,
    monthlyFee: card.monthlyFee.toString(),
    minimumBalanceForNoFee: card.minimumBalanceForNoFee.toString(),
    ...
    notes: card.notes || '',
    // Transaction limits
    hasTransactionLimits: !!card.transactionLimits,
    monthlyLimit: card.transactionLimits?.monthly?.toString() || '',
    perTransactionLimit: card.transactionLimits?.perTransaction?.toString() || ''
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedCard: Partial<BankCard> = {
    ...
    updateBankCard(card.id, updatedCard);
    onClose();
  };
